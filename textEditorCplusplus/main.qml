...
ApplicationWindow {
    ...
    Action {
        ...
        icon.source: "qrc:/flat/outlines/new.svg"
    ...
    Action {
        ...
        text: qsTr("Open")
        icon.color: "transparent"
        icon.source: "qrc:/flat/outlines/open.svg"
    ...
    Action {
        ...
        text: qsTr("Save")
        icon.color: "transparent"
        icon.source: "qrc:/flat/outlines/save.svg"
    ...
    Action {
        ...
        text: qsTr("Copy")
        icon.color: "transparent"
        icon.source: "qrc:/flat/outlines/copy.svg"
    ...
    Action {
        ...
        text: qsTr("Cut")
        icon.color: "transparent"
        icon.source: "qrc:/flat/outlines/cut.svg"
    ...
    Action {
        ...
        text: qsTr("Paste")
        icon.color: "transparent"
        icon.source: "qrc:/flat/outlines/paste.svg"
